...
This module provides a Ballerina client for the [Agent2Agent (A2A) protocol](https://a2a-protocol.org/latest/specification/), an open protocol for communication between independent AI agents.
